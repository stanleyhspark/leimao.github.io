...
def Train_Model(env = env):
    ...
    while episode < EPISODE_MAX:
        ...
        while True:  
            ...
            action = AI_player.Test(observation = observation)
            observation_next, reward, done, info = env.step(action)

            AI_player.Train(observation = observation, action = action, reward = reward, done = done, observation_next = observation_next)
